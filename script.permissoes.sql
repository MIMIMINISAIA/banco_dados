...
-- exercicio 1 Crie um usuário chamado aluno1 com senha senha123 que pode se conectar a 
...
-- exercicio 2 Crie um usuário chamado professor1 com senha senha456 que pode se 
...
-- exercicio 3 Crie um usuário chamado admin1 com senha senha789 que pode se conectar a 
...
-- exercicio 4 Revogue a permissão de seleção (SELECT) da tabela alunos para o usuário aluno1.
revoke select on escola.alunos  from 'aluno1'@'localhost';


-- exercicio 5 Crie um usuário chamado aluno2 com senha senha321 que pode se conectar a 
...
-- exercicio 6 Revogue todas as permissões do usuário admin1 no banco de dados escola.
revoke all privileges on escola. *  from 'admin1'@'localhost';

-- exercicio 7 Crie um usuário chamado professor2 com senha senha654 que pode se 
...
-- exercicio 8 Revogue a permissão de inserção (INSERT) da tabela notas para o usuário professor1.
revoke insert on escola.notas  from 'professor1'@'%';
show grants for 'professor1'@'%';

-- exercicio 9 Crie um usuário chamado aluno3 com senha senha987 que pode se conectar a 
...
-- exercicio 10 Revogue todas as permissões do usuário professor2 na tabela notas do banco 
-- de dados escola.
revoke update on escola.notas  from 'professor2'@'%';
show grants for 'professor2'@'%';
